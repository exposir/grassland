[
  {
    ...
    labels_url:
      "https://api.github.com/repos/exposir/grassland/issues/3/labels{/name}",
    comments_url:
      "https://api.github.com/repos/exposir/grassland/issues/3/comments",
    events_url:
      "https://api.github.com/repos/exposir/grassland/issues/3/events",
    ...
    user: {
      ...
      following_url:
        "https://api.github.com/users/exposir/following{/other_user}",
      gists_url: "https://api.github.com/users/exposir/gists{/gist_id}",
      starred_url:
        "https://api.github.com/users/exposir/starred{/owner}{/repo}",
      ...
      received_events_url:
        "https://api.github.com/users/exposir/received_events",
      type: "User",
      site_admin: false,
    },
    labels: [
    ...
    updated_at: "2022-02-23T17:04:26Z",
    closed_at: null,
    ...
    timeline_url:
      "https://api.github.com/repos/exposir/grassland/issues/3/timeline",
  ...
  },
  {
    ...
    repository_url: "https://api.github.com/repos/exposir/grassland",
    labels_url:
      "https://api.github.com/repos/exposir/grassland/issues/2/labels{/name}",
    comments_url:
      "https://api.github.com/repos/exposir/grassland/issues/2/comments",
    events_url:
      "https://api.github.com/repos/exposir/grassland/issues/2/events",
    ...
    updated_at: "2022-02-23T17:04:04Z",
    closed_at: null,
    author_association: "OWNER",
    active_lock_reason: null,
    ...
    timeline_url:
      "https://api.github.com/repos/exposir/grassland/issues/2/timeline",
    performed_via_github_app: null,
  },
  {
    ...
    repository_url: "https://api.github.com/repos/exposir/grassland",
    labels_url:
      "https://api.github.com/repos/exposir/grassland/issues/1/labels{/name}",
    comments_url:
      "https://api.github.com/repos/exposir/grassland/issues/1/comments",
    events_url:
      "https://api.github.com/repos/exposir/grassland/issues/1/events",
    ...
    updated_at: "2022-02-23T13:23:24Z",
    closed_at: null,
    author_association: "OWNER",
    active_lock_reason: null,
    ...
    timeline_url:
      "https://api.github.com/repos/exposir/grassland/issues/1/timeline",
    performed_via_github_app: null,
  },
];
